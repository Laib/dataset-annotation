...
input_dir = '/home/wfu/data/wfuletters/data';
...
for i = 1:size(picture_fullpaths, 1)
    ...
    isat = saturate(i, 1.5);
    outputfilename = sprintf('%s/%s_%s.png', output_dir, name, 'sat1');
    ...
    isat = saturate(i, 0.5);
    outputfilename = sprintf('%s/%s_%s.png', output_dir, name, 'sat2');
    imwrite(isat, outputfilename);
    
    %gaussfilter
    isat = imgaussfilt(i, 2);
    outputfilename = sprintf('%s/%s_%s.png', output_dir, name, 'g1');
    imwrite(isat, outputfilename);
    
    %gaussfilter
    isat = imgaussfilt(i, 3);
    outputfilename = sprintf('%s/%s_%s.png', output_dir, name, 'g2');
    imwrite(isat, outputfilename);
    ...
    T = maketform('affine', [1 0 0; a 1 0; 0 0 1] );
    isat = imtransform(i,T,R);
    outputfilename = sprintf('%s/%s_%s.png', output_dir, name, 'trans2');
    imwrite(isat, outputfilename);
    ...
    T = maketform('affine', [1 0 0; a 1 0; 0 0 1] );
    isat = imtransform(i,T,R);
    outputfilename = sprintf('%s/%s_%s.png', output_dir, name, 'trans4');
    imwrite(isat, outputfilename);
    ...
    T = maketform('affine', [1 0 0; a 1 0; 0 0 1] );
    isat = imtransform(saturated_i,T,R);
    outputfilename = sprintf('%s/%s_%s.png', output_dir, name, 'strans2');
    imwrite(isat, outputfilename);
    ...
    T = maketform('affine', [1 0 0; a 1 0; 0 0 1] );
    isat = imtransform(saturated_i,T,R);
    outputfilename = sprintf('%s/%s_%s.png', output_dir, name, 'strans4');
    imwrite(isat, outputfilename);
end